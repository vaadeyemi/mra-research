...
export default function App() {
  ...
  return (
    ...
    <div className="min-h-screen w-full bg-[#0b1a34] text-white font-serif">
      ...
      <section className="px-4 py-16">
        ...
        <div className="mx-auto grid max-w-4xl gap-8 text-center md:grid-cols-5">
          {[
            ...
            <div
              key={v.title}
              className="rounded-2xl border border-gold p-4"
            >
      ...
      <section
        id="membership"
        className="bg-[#0d203f] px-4 py-20 text-center"
      >
      ...
      <section id="contact" className="bg-[#0d203f] px-4 py-16 text-center">
        ...
        <p className="mb-8">Have questions? Reach out to us via the form.</p>
        {/* Replace with an actual contact form or modal later */}
        <button className="rounded-2xl bg-gold px-8 py-3 text-[#081123]">
          Open Contact Form
        </button>
      </section>
